...
csv_wm_test <- "./data/wm_data/wm_processed.csv"
...
data_hexaco <- select(surveys_sel_cols, email, contains("OPEN"), 
  ...
  select(-contains("OPEN"), -contains("CONSC"), -contains("AGREE"),
         -contains("EXTRA"), -contains("EMOTION"), -contains("HONHUM"))
...
data_power_scale <- select(surveys_sel_cols, email, contains("FP"),
  ...
  select(-contains("AP"), -contains("FP"), -contains("DP"))
